...
// import Addrecipies1 from './registerform.js';
    ...
    return (
      <>
        ...
        <p className="text-center bg-success float-left" style={{ color: "azure", fontSize: "30px" }}>Food Recipies</p>
          ...
          <ModalHeader>
            <div style={{justifyContent:"center",width:"600px",marginLeft:"300px"}}> <b>ADD  RECIPIES</b></div>
          ...
          <button className="btn btn-danger" style={{marginBottom:"5px" }} onClick={this.closeModal}>X</button>
            ...
            <Addrecipies1
              onAddRecipe={(e)=>  this.onAddRecipe(e)}
            />   
          </Modal>   
        </div>
      </>
